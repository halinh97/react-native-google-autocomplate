...
export default class GooglePlacesAutocomplete extends Component {
  ...
  componentWillMount() {
    this._request = this.props.debounce
      ...
      : this._request;
      let text = this.props.getDefaultValue();
      let row = {
  ...
  _renderPoweredLogo = () => {
    ...
    return (
      ...
      >
        {
          !this.props.predefinedPlacesAlwaysVisible &&
        <Image
        ...
        {!this.props.textInputHide &&
          ...
          >
            ...
            <TextInput
              ...
              style={[defaultStyles.textInput, {backgroundColor: 'white', fontSize: 17 ,height: 45,fontWeight:'bold'},this.props.styles.textInput]}
...
GooglePlacesAutocomplete.propTypes = {
  ...
  autoFillLocation: PropTypes.bool,
